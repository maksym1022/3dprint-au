...
function webnus_footer_script_loader(){
	...
	wp_register_script('custom_script', get_template_directory_uri() . '/js/brazil-custom.js', null, null, true);
	$arr = array('ajaxurl'=> admin_url('admin-ajax.php'));
	wp_localize_script('custom_script','obj',$arr );
