...
class WC_Order_Status_Manager_Admin {
	...
	public function load_styles_scripts() {
		...
		if ( $this->is_order_status_manager_screen() ) {
			...
			wp_enqueue_script( 'wc-order-status-manager-admin', wc_order_status_manager()->get_plugin_url() . '/assets/js/admin/wc-order-status-manager-admin.min.js', array( 'jquery', 'jquery-tiptip', 'select2' ),  WC_Order_Status_Manager::VERSION );
