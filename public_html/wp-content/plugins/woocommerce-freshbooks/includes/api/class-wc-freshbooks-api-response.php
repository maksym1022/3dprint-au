 ...
 *
 * @package   WC-FreshBooks/API/Response
 * @author    SkyVerge
 ...
 * @since 3.0
 */
class WC_FreshBooks_API_Response implements SV_WC_API_Response {
	...
	public function get_api_error_message() {
		...
		if ( ! isset( $this->response_xml->error ) ) {
			return __( 'N/A', WC_FreshBooks::TEXT_DOMAIN );
		}
	...
	/**
	 * Returns the created invoice ID from a create invoice API call
	 *
	 * @since 3.0
	 * @throws Exception missing invoice ID
	 * @return string created invoice ID
	 */
	public function parse_create_invoice() {

		if ( ! isset( $this->response_xml->invoice_id ) ) {
			throw new SV_WC_API_Exception( __( 'Created invoice ID is missing', WC_FreshBooks::TEXT_DOMAIN ) );
		}
	...
	/**
	 * Returns the created client ID from a create client API call
	 *
	 * @since 3.0
	 * @throws Exception missing client ID
	 * @return string created client ID
	 */
	public function parse_create_client() {

		if ( ! isset( $this->response_xml->client_id ) ) {
			throw new SV_WC_API_Exception( __( 'Created client ID is missing', WC_FreshBooks::TEXT_DOMAIN ) );
		}
	...
	/**
	 * Returns the created payment ID from a create payment API call
	 *
	 * @since 3.0
	 * @throws Exception missing payment ID
	 * @return string created payment ID
	 */
	public function parse_create_payment() {

		if ( ! isset( $this->response_xml->payment_id ) ) {
			throw new SV_WC_API_Exception( __( 'Created payment ID is missing', WC_FreshBooks::TEXT_DOMAIN ) );
		}
	...
	/**
	 * Returns the created webhook ID from a create webhook API call
	 *
	 * @since 3.0
	 * @throws Exception missing webhook ID
	 * @return string created webhook ID
	 */
	public function parse_create_webhook() {

		if ( ! isset( $this->response_xml->callback_id ) ) {
			throw new SV_WC_API_Exception( __( 'Created webhook ID is missing', WC_FreshBooks::TEXT_DOMAIN ) );
		}
