 ...
 * @since 3.0
 */
class WC_FreshBooks_API extends SV_WC_API_Base {
	 ...
	 *
	 * Note this requires a client to have already been created for the associated
	 * invoice
	 *
	 * @since 3.0
	...
	/**
	 * Fetch clients with the specified email
	 *
	 * @since 3.0
	...
	/**
	 * Create a invoice payment for the given order
	 *
	 * @since 3.0
	...
	/**
	 * Fetch languages available for invoices
	 *
	 ...
	 *
	 * Note this isn't for verifying individual webhook events, but rather for
	 * verifying that the URL specifed when creating the webhook actually exists
	 * and is valid
	 *
	 * @since 3.0
	 * @param string $webhook_id to verify
	 * @param string $verifier verification string
	 * @throws SV_WC_API_Exception verification failed, network issues, timeouts, API errors, etc
	 */
	...
	protected function do_post_parse_response_validation() {
		...
		if ( $this->get_response()->has_api_error() ) {
			...
			throw new SV_WC_API_Exception( $this->get_response()->get_api_error_message(), $this->get_response()->get_api_error_code() );
		}
	}
