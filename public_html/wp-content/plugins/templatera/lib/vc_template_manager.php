...
if (!class_exists('VcTemplateManager')) {
    Class VcTemplateManager
    {
        ...
        function initPluginLoaded() {
            ...
            add_action('vc_admin_inline_editor', array(&$this, 'addEditorTemplates'));
                ...
                if ($button[0] != 'templates') {
                    ...
                    if (get_post_type() == self::$post_type) {
                        ...
                        $new_buttons[] = array('custom_templates', '
                                <li><a href="#" class="vc_templatera_button"  id="vc-templatera-editor-button" title="'.__('Templates', 'js_composer').'"></a></li>');
                    }
        ...
        public function addEditorTemplates() {
            wp_enqueue_script('vc_plugin_inline_templates', $this->assetURL('js/inline.js'), array('vc_inline_js'), time(), true);
