            ...
            <div style="margin: 0px auto 10px auto; width: 100%; overflow: hidden; padding: 0 20px;">
                ...
                <div class="pull-left" style="width: 410px; padding: 40px 20px;">
                    ...
                    <form role="form" id="new-user-form" class="<?php echo isset($user_id) && !empty($user_id) ? 'hide' : '' ?>">
                        ...
                        <div class="container hide woo">
                            <div class="form-group" style="width: 352px;">
                                <label for="url">For Woocommerce</label>
                        ...
                        <!--<a class="are_you_new" href="<?php echo get_admin_url() ?>admin.php?page=Returning-user-without-uid" style="margin-left: 20px; font-weight: bold; font-size: 14px;">Are you an existing user?</a>-->
                    </form>
...
//                    jQuery("#email").closest(".container").find("span").css({'color': 'green'});
    ...
    jQuery(document).on("click", "input[name='platform']", function () {

        if (this.value === 'woocommerce') {
            jQuery(".woo").removeClass("hide");
            //jQuery(".pass_div").addClass("hide");
        } else {
            jQuery(".woo").addClass("hide");
            //jQuery(".pass_div").removeClass("hide");
        }
    });
    ...
    jQuery(document).on("click", "#create-user-btn", function () {
        ...
        email_is_valid = url_is_valid = site_name_is_valid = 1;

        if (email_is_valid == 1 && url_is_valid == 1 && site_name_is_valid == 1) {
