...
class Kudobuzzwp {
     ...
     * Create account
     */
    function create_user($email, $account_name, $url, $password, $platform) {

        return json_decode($this->run_curl(KUDOBUZZ_MAIN_URL . "users/create", "POST", array(
                    'email' => $email,
    ...
    /**
     * Create a woo commerce user
     */
    function create_woo_user($param) {
        
        return json_decode($this->run_curl(KUDOBUZZ_MAIN_URL . "users/create", "POST", $param));
    }
