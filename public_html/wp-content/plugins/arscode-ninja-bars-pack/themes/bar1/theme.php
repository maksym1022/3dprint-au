<?php
function snp_enqueue_bar1($POPUP_META)
{
...
$SNP_THEMES_bar1_SIZES = array();
for ($i = 10; $i <= 72; $i++)
{
    $SNP_THEMES_bar1_SIZES[$i]	 = $i . 'px';
}
$SNP_THEMES['bar1']		 = array(
    'NAME'		 => 'Bar 1',
    'STYLES'	 => 'style.css',
    'OPEN_FUNCTION'	 => 'snp_bar1_open',
    'CLOSE_FUNCION'	 => 'snp_bar1_close',
    'TYPES'		 => array(
	...
	array(
	    ...
	    'type'	 => 'color',
	    'std'	 => '#F2522D',
	    'desc'	 => __('(default: #F2522D)', 'nhp-opts'),
	...
	array(
	    ...
	    'type'	 => 'color',
	    'std'	 => '#D43511',
	    'desc'	 => __('(default: #D43511)', 'nhp-opts'),
	...
	array(
	    ...
	    'desc'	 => __('px (default: 26px, #ffd0c5)', 'nhp-opts'),
	    'args'	 => array(
		'sizes'	 => $SNP_THEMES_bar1_SIZES,
		'fonts'	 => snp_get_fonts(),
	    ),
	    'std'	 => array('font'	 => 'Open Sans', 'size'	 => '26', 'color'	 => '#ffd0c5'),
	),
	array(
	    'id'	 => 'maintext',
	    'type'	 => 'textarea',
	...
	array(
	    ...
	    'std'	 => array('font'	 => 'Open Sans', 'size'	 => '14', 'color'	 => '#ffffff'),
	),
	array(
	    'id'	 => 'name_placeholder',
	    'type'	 => 'text',
	...
	array(
	    ...
	    'type'	 => 'color',
	    'std'	 => '#b02000',
	    'desc'	 => __('(default: #b02000)', 'nhp-opts'),
	...
	array(
	    ...
	    'type'	 => 'color',
	    'std'	 => '#861800',
	    'desc'	 => __('(default: #861800)', 'nhp-opts'),
	...
	array(
	    ...
	    'type'	 => 'color',
	    'std'	 => '#ffbdae',
	    'desc'	 => __('(default: #ffbdae)', 'nhp-opts'),
