...
function snp_enqueue_bar15($POPUP_META)
{
...
$SNP_THEMES_bar15_SIZES = array();
for ($i = 10; $i <= 100; $i++)
{
    $SNP_THEMES_bar15_SIZES[$i]	 = $i . 'px';
}
$SNP_THEMES['bar15']		 = array(
    'NAME'	 => 'Bar 15',
    'STYLES' => 'style.css',
    'OPEN_FUNCTION' => 'snp_bar15_open',
    'CLOSE_FUNCION' => 'snp_bar15_close',
    'TYPES'	 => array(
	...
	array(
	    ...
	    'desc'	 => __('px (default: 100px, #b2ada0)', 'nhp-opts'),
	    'args'	 => array(
		'sizes'		 => $SNP_THEMES_bar15_SIZES,
		'fonts'	 => snp_get_fonts(),
	    ),
	    'std'		 => array('font'	 => 'Arial Black','size'	 => '100', 'color'	 => '#b2ada0'),
	),
	array(
	    'id'	 => 'name_placeholder',
	    'type'	 => 'text',
