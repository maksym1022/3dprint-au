...
jQuery(function ($) {
	...
	var do_popup_function = function() {
		$.colorbox({
			...
			onComplete: function() {
				$('.cbox_wpp_theme_1.cboxOverlay').css( 'background', options.mask_color );
...
<div style='display:none'>
	...
	<div id='<?php echo $this->id . '-auto_popup-' . $popup_id ?>' style='padding:0px;' class="<?php echo $uniq_id ?> wpp_theme_1 wpp_d1_main">
			<form>
			  <div class="wpp_d1_heading"><?php echo $settings['heading'] ?></div>
			  <div class="wpp_d1_bottom">
			    <table class="wpp_d1_table">
			      <tr>
			        <td class="td_wpp_d1_subheading"><span class="wpp_d1_subheading" ><?php echo $settings['sub_heading'] ?></span></td>
			      </tr>
			      <tr>
